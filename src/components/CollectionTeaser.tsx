    ...
    <section className="relative overflow-hidden bg-surface py-40 px-8 text-center">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 opacity-5 pointer-events-none">
        <svg width="600" height="400" viewBox="0 0 600 400" fill="none">
          <path
            d="M60 400 Q60 0 300 0 Q540 0 540 400"
            stroke="#c9a96e"
            strokeWidth="1.5"
            fill="none"
          />
          <path
            d="M90 400 Q90 30 300 30 Q510 30 510 400"
            stroke="#c9a96e"
            strokeWidth="0.8"
            fill="none"
            opacity="0.5"
      ...
      >
        The Collection<br />
        <span className="font-semibold text-accent" style={{ WebkitTextStroke: '0.6px rgba(201,169,110,0.6)' }}>Awaits You</span>
      </motion.h2>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
